...
class ProgressController: WABaseController {
    ...
    private let monthlyPerformanceView = MonthlyPerformance(with: R.Strings.Progress.monthlyPerformance, buttonTitle: R.Strings.Progress.last10months)
}
...
extension ProgressController {
    ...
    override func configureAppearance() {
        ...
        addNavButton(at: .left, with: R.Strings.Progress.navBarLeft)
        addNavButton(at: .right, with: R.Strings.Progress.navBarRight)
